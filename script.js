...
const heroLines = [
    ...
    { n: 4, html: '&nbsp;&nbsp;stack: [<span class="str">"React"</span>, <span class="str">"JavaScript"</span>, <span class="str">"DSA"</span>, <span class="str">"SQL"</span>],' },
    { n: 5, html: '&nbsp;&nbsp;status: <span class="str">"open to fresher opportunities"</span> <span class="com"></span>' },
    { n: 6, html: '};' },
];
